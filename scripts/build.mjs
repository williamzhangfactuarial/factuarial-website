    ...
    <header class="site-header">
      ...
      <nav aria-label="Main navigation">
        ...
        <div class="products-menu">
          <button class="nav-link products-trigger ${section === 'products' ? 'is-current' : ''}" type="button" aria-expanded="false" aria-controls="products-options">Products<span class="chevron" aria-hidden="true"></span></button>
...
const contact = `
      <section class="hero contact-hero" aria-labelledby="page-title"><h1 id="page-title">Let’s talk.</h1><p class="intro">Tell us who you are and what you’re working on.</p><p class="contact-email">You can also reach us at<br><a href="mailto:contact@factuarial.insure">contact@factuarial.insure</a>.</p></section>
